...
export const REGISTER = createAction('[Register]', props<{ username: string, }>())
export const REGISTER_SUCCESS = createAction('[Register]', props<{ username: string }>())
export const REGISTER_FAILURE = createAction('[Register]')
